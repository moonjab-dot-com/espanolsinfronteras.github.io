...
export const courses: Course[] = [
  ...
  },
  {
    ...
    icon: "BookOpen",
    colorClass: "amber",
    titleEs: "Historia Americana",
    titleEn: "American History",
    descriptionEs: "Historia, gobierno y civismo de los Estados Unidos: desde los Padres Fundadores hasta hoy.",
    descriptionEn: "American history, government and civics: from the Founding Fathers to the present day.",
    chapters: [
      ...
      { id: 6,  title: "La Carta de Derechos: Tus Libertades",        href: "/content/CIUDADANIA CAP 6 La Carta de Derechos Tus Libertades ESF.html" },
  ...
  },
  {
    ...
    descriptionEn: "Prepare for the U.S. naturalization exam with the 100 official USCIS civics questions.",
    chapters: [
      { id: 1,  title: "Principios de la Democracia Americana",      href: "/content/CIUDADANIA CAP 1 Principios de la Democracia America ESF.html" },
      { id: 2,  title: "El Sistema Federal y los 50 Estados",         href: "/content/CIUDADANIA CAP 2 El Sistema Federal y los 50 Estados ESF.html" },
      { id: 3,  title: "El Congreso: La Rama Legislativa",            href: "/content/CIUDADANIA CAP 3 El Congreso La Rama Legislativa ESF.html" },
