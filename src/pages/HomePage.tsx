        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div>
            <div className="animate-fade-up inline-flex items-center gap-2 px-4 py-2 rounded-full border border-white/12 bg-white/5 text-white/75 text-xs font-semibold mb-8">
              ...
              {t ? "100% Gratuito · 237+ lecciones · Quiz interactivo" : "100% Free · 237+ lessons · Interactive quiz"}
            </div>
            ...
            <p className="animate-fade-up delay-150 text-[17px] text-white/55 leading-relaxed mb-10 max-w-[480px]">
              {t
                ? "Plataforma educativa gratuita con 237+ lecciones en español, finanzas, programación, matemáticas y más. Sin registro, sin costo, para siempre."
                : "Free educational platform with 237+ lessons covering Spanish, finance, programming, math, and more. No sign-up, no cost, forever."}
            </p>
        ...
        <Reveal>
          <div className="text-center mb-14">
            ...
            <p className="text-muted-foreground text-base max-w-sm mx-auto">
              {t
                ? "14 materias, 237+ capítulos. Todo 100% gratuito, sin registro."
                : "14 subjects, 237+ chapters. All 100% free, no sign-up."}
            </p>
          </div>
        </Reveal>
              ...
              {t ? (
                <>
                  ...
                  <p>
                    ...
                    <strong className="text-foreground font-semibold">237 capítulos</strong> diseñados para ser prácticos, accesibles y útiles en la vida real.
                  </p>
                  <p>
                ...
                <>
                  ...
                  <p>
                    ...
                    <strong className="text-foreground font-semibold">237 chapters</strong> designed to be practical, accessible, and useful in real life.
                  </p>
                  <p>
